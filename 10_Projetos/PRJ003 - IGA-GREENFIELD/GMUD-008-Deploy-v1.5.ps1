...
# STEP 3/4: DOCKER COMPOSE (Injeção de Texto Puro para evitar erro de expansão)
$yaml = @"
services:
  postgres:
...
Write-Host "✅ Docker-compose.yml gerado com sucesso na VM" -ForegroundColor Green
