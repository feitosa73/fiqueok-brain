...
PROVISIONAMENTO FINAL NO AZURE
...
PS C:\WINDOWS\system32> Connect-MgGraph -TenantId "503bbd0e-f33f-4ebe-b12e-f24a506978c9" -Scopes "User.ReadWrite.All", "Group.ReadWrite.All"
Welcome to Microsoft Graph!
...
PS C:\WINDOWS\system32>
PS C:\WINDOWS\system32>
PS C:\WINDOWS\system32> $GruposParaCriar = @("GRP_EXEC_BOARD", "GRP_IT_DEV", "GRP_IT_DEVOPS", "GRP_SEC_ADMINS", "GRP_DATA_ENGINEERS", "GRP_FRAUD_COMPLIANCE", "GRP_COMMERCIAL_CS", "GRP_HR_FINANCE")
PS C:\WINDOWS\system32>
PS C:\WINDOWS\system32> foreach ($Nome in $GruposParaCriar) {
>>     try {
>>         New-MgGroup -DisplayName $Nome -MailEnabled $false -SecurityEnabled $true -MailNickname ($Nome.ToLower().Replace(" ","")) -Description "Grupo de acesso PRJ011"
>>         Write-Host "[OK] Grupo Criado: $Nome" -ForegroundColor Cyan
>>     } catch {
>>         Write-Host "[INFO] Grupo $Nome ja existe." -ForegroundColor Yellow
>>     }
>> }
[INFO] Grupo GRP_EXEC_BOARD ja existe.
[INFO] Grupo GRP_IT_DEV ja existe.
[INFO] Grupo GRP_IT_DEVOPS ja existe.
[INFO] Grupo GRP_SEC_ADMINS ja existe.
[INFO] Grupo GRP_DATA_ENGINEERS ja existe.
[INFO] Grupo GRP_FRAUD_COMPLIANCE ja existe.
[INFO] Grupo GRP_COMMERCIAL_CS ja existe.
[INFO] Grupo GRP_HR_FINANCE ja existe.
PS C:\WINDOWS\system32> $CSVPath = "C:\Projetos\Obsidian\Fiqueok_Brain\10_Projetos\PRJ011 - Export Orange - EntraID\fiqueok_entraid_users.csv"
PS C:\WINDOWS\system32> $Users = Import-Csv $CSVPath -Encoding UTF8
PS C:\WINDOWS\system32>
PS C:\WINDOWS\system32> $Map = @{
>>     "Executive"             = "GRP_EXEC_BOARD"
>>     "Technology - Dev"      = "GRP_IT_DEV"
>>     "Technology - DevOps"   = "GRP_IT_DEVOPS"
>>     "Technology - Security" = "GRP_SEC_ADMINS"
>>     "Technology - Data"     = "GRP_DATA_ENGINEERS"
>>     "Fraud & Compliance"    = "GRP_FRAUD_COMPLIANCE"
>>     "Commercial & CS"       = "GRP_COMMERCIAL_CS"
>>     "HR & Finance"          = "GRP_HR_FINANCE"
>> }
PS C:\WINDOWS\system32>
PS C:\WINDOWS\system32> foreach ($User in $Users) {
>>     $GroupName = $Map[$User.Department]
>>     if ($GroupName) {
>>         try {
>>             # Obtendo IDs via e-mail e nome do grupo
>>             $GrpId = (Get-MgGroup -Filter "DisplayName eq '$GroupName'").Id
>>             $UsrId = (Get-MgUser -UserId $User.UserPrincipalName).Id
>>
>>             if ($GrpId -and $UsrId) {
>>                 New-MgGroupMember -GroupId $GrpId -DirectoryObjectId $UsrId
>>                 Write-Host "[MEMBER] $($User.DisplayName) -> $GroupName" -ForegroundColor Green
>>             }
>>         } catch {
>>             Write-Host "[SKIP] $($User.DisplayName) ja e membro ou erro de ID." -ForegroundColor Gray
>>         }
>>     }
>> }
PS C:\WINDOWS\system32> Get-MgGroup | Select-Object DisplayName, @{Name="MemberCount"; Expression={(Get-MgGroupMember -GroupId $_.Id -All).Count}} | Format-Table

DisplayName         MemberCount
-----------         -----------
lvl1-core-emergency           1
lvl2-sec-ops                  0
lvl3-infra-tech               1


PS C:\WINDOWS\system32> Get-MgGroup -Filter "startsWith(DisplayName, 'GRP_')" | `
>> Select-Object DisplayName, @{Name="Total_Membros"; Expression={(Get-MgGroupMember -GroupId $_.Id -All).Count}} | `
>> Format-Table -AutoSize
PS C:\WINDOWS\system32>
PS C:\WINDOWS\system32>
PS C:\WINDOWS\system32> Get-MgGroup -All | Select-Object DisplayName, Id | Sort-Object DisplayName

DisplayName         Id
-----------         --
lvl1-core-emergency 04549ad0-c5fa-4124-86fa-06bd10a0e069
lvl2-sec-ops        972147d5-f410-4aea-be68-003a150dbfdd
lvl3-infra-tech     d53c1bba-a786-4e40-8dae-5cdc6ca94ffd


PS C:\WINDOWS\system32>
PS C:\WINDOWS\system32>
PS C:\WINDOWS\system32> $MeusGrupos = Get-MgGroup -All | Where-Object { $_.DisplayName -like "GRP_*" }
PS C:\WINDOWS\system32> $MeusGrupos | Select-Object DisplayName, @{Name="Membros"; Expression={(Get-MgGroupMember -GroupId $_.Id -All).Count}} | Format-Table
PS C:\WINDOWS\system32>
>>
>> ^C
PS C:\WINDOWS\system32> # Extrair uma amostra de 10 usuários para validar se Department e JobTitle entraram
PS C:\WINDOWS\system32> Get-MgUser -All -Property "DisplayName,Department,JobTitle,EmployeeId" | `
>> Where-Object { $_.EmployeeId -like "FP*" } | `
>> Select-Object DisplayName, Department, JobTitle, EmployeeId -First 10 | `
>> Format-Table -AutoSize

DisplayName      Department          JobTitle                     EmployeeId
-----------      ----------          --------                     ----------
Aline Teixeira   Technology - DevOps Automation Specialist        FP018
Amanda Freitas   Operations          Settlement Analyst           FP029
Amanda Prado     Technology - DevOps DevOps Specialist            FP073
Ana Paula        Commercial & CS     Customer Success Analyst     FP049
Anderson Peixoto HR & Finance        Payroll Specialist           FP060
Andre Chaves     Executive           Chairman                     FP002
Andre Costa      Technology - Dev    Full Stack Developer         FP014
Andreia Abreu    Commercial & CS     Sales Operations Analyst     FP086
Arthur Henrique  Commercial & CS     Customer Experience Designer FP078
Beatriz Moreira  HR & Finance        Compensation Analyst         FP079


PS C:\WINDOWS\system32>
PS C:\WINDOWS\system32>
PS C:\WINDOWS\system32> New-MgGroup -DisplayName "GRP_AUDIT_EVIDENCE" -MailEnabled $false -SecurityEnabled $true -MailNickname "audit.evidence" -Description "Evidência final do PRJ011"
New-MgGroup : Não é possível localizar um parâmetro posicional que aceite o argumento 'False'.
No linha:1 caractere:1
+ New-MgGroup -DisplayName "GRP_AUDIT_EVIDENCE" -MailEnabled $false -Se ...
+ ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    + CategoryInfo          : InvalidArgument: (:) [New-MgGroup], ParameterBindingException
    + FullyQualifiedErrorId : PositionalParameterNotFound,New-MgGroup

PS C:\WINDOWS\system32>
PS C:\WINDOWS\system32> $GroupParams = @{
>>     DisplayName     = "GRP_AUDIT_EVIDENCE"
>>     Description     = "Evidencia final do PRJ011 - Concluido"
>>     MailEnabled     = $false
>>     SecurityEnabled = $true
>>     MailNickname    = "audit.evidence"
>> }
PS C:\WINDOWS\system32>
PS C:\WINDOWS\system32> New-MgGroup @GroupParams

DisplayName        Id                                   MailNickname   Description                           GroupTypes
-----------        --                                   ------------   -----------                           ----------
GRP_AUDIT_EVIDENCE a47a25b8-217e-4dfc-a79a-5616aac2caa9 audit.evidence Evidencia final do PRJ011 - Concluido {}


PS C:\WINDOWS\system32> # PRJ011 - Extração de Evidências de Auditoria de IAM
PS C:\WINDOWS\system32> $ExportPath = "C:\Projetos\Obsidian\Fiqueok_Brain\10_Projetos\PRJ011 - Export Orange - EntraID\Evidencias\Evidencia_Final_Provisionamento.csv"
PS C:\WINDOWS\system32>
PS C:\WINDOWS\system32> Write-Host "Iniciando auditoria das identidades FP..." -ForegroundColor Cyan
Iniciando auditoria das identidades FP...
PS C:\WINDOWS\system32>
PS C:\WINDOWS\system32> # Extraindo todos os usuários criados no projeto
PS C:\WINDOWS\system32> $Report = Get-MgUser -All -Property "DisplayName,UserPrincipalName,Department,JobTitle,EmployeeId,CreatedDateTime" | `
>>           Where-Object { $_.EmployeeId -like "FP*" } | `
>>           Select-Object DisplayName, UserPrincipalName, Department, JobTitle, EmployeeId, CreatedDateTime
PS C:\WINDOWS\system32>
PS C:\WINDOWS\system32> # Gerando o CSV de auditoria
PS C:\WINDOWS\system32> $Report | Export-Csv -Path $ExportPath -NoTypeInformation -Encoding UTF8
PS C:\WINDOWS\system32>
PS C:\WINDOWS\system32> Write-Host "RELATÓRIO CONCLUÍDO!" -ForegroundColor Green
RELATÓRIO CONCLUÍDO!
PS C:\WINDOWS\system32> Write-Host "Total de identidades auditadas: $($Report.Count)"
Total de identidades auditadas: 100
PS C:\WINDOWS\system32> Write-Host "Arquivo salvo em: $ExportPath"
Arquivo salvo em: C:\Projetos\Obsidian\Fiqueok_Brain\10_Projetos\PRJ011 - Export Orange - EntraID\Evidencias\Evidencia_Final_Provisionamento.csv
PS C:\WINDOWS\system32>
PS C:\WINDOWS\system32>
PS C:\WINDOWS\system32>
