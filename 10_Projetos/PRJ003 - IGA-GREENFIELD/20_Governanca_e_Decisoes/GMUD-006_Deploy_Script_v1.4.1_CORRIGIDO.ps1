# ==============================================================================
# GMUD-006 — SCRIPT DE DEPLOY COM ORQUESTRAÇÃO DE BOOTSTRAP (v1.4.1)
# ==============================================================================
...
# Versão: 1.4.1 (Correção de IP: xxx.xxx.xxx.xxx)
# ==============================================================================
...
# --------------------------
# CORREÇÃO CRÍTICA v1.4.1: IP atualizado de .112 para .116
$VM_USER = "paulo"
...
Write-Host "  1️⃣  'Created User:administrator'" -ForegroundColor Green
Write-Host "  2️⃣  'Server startup in XXXXX milliseconds'" -ForegroundColor Green
...
Write-Host "  [ ] V03: Log midPoint - 'Created User:administrator'" -ForegroundColor Gray
Write-Host "  [ ] V04: Log midPoint - 'Server startup'" -ForegroundColor Gray
Write-Host "  [ ] V05: Interface web acessível" -ForegroundColor Gray
Write-Host "  [ ] V06: Login bem-sucedido" -ForegroundColor Gray
...
Write-Host "    Senha:   5ecurity" -ForegroundColor Green
